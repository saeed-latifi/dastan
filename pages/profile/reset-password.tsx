...
export default function RecoverPassword() {
	...
	return (
		<Form onSubmit={handleSubmit(onResetPassword)}>
			<FormInput labelText="password" type="password" warnings={errors.password?.message} register={register("password")} required />
			<FormInput labelText="confirm" type="password" warnings={errors.confirm?.message} register={register("confirm")} required />
